...
var K2 = class L {
  ...
  _setupStateMachineObservers() {
    ...
    i.setOnStart(() => {
      ...
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: r, newValue: l, oldValue: w });
    }), i.setOnNumericInputValueChange((r, l, w) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: r, newValue: l, oldValue: w });
    }), i.setOnStringInputValueChange((r, l, w) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: r, newValue: l, oldValue: w });
    }), i.setOnInputFired((r) => {
